...
class VeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post veiculos_url, params: { veiculo: { descricao: @veiculo.descricao, marca: @veiculo.marca, nome_veiculo: @veiculo.nome_veiculo, vendido: @veiculo.vendido } }
    end
  ...
  test "should update veiculo" do
    patch veiculo_url(@veiculo), params: { veiculo: { descricao: @veiculo.descricao, marca: @veiculo.marca, nome_veiculo: @veiculo.nome_veiculo, vendido: @veiculo.vendido } }
